...
public sealed class SQLite3Provider_e_sqlite3 : ISQLite3Provider
{
	...
	private static class NativeMethods
	{
		...
		[DllImport("e_sqlite3", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
		public static extern IntPtr sqlite3_progress_handler(sqlite3 db, int instructions, callback_progress_handler func, hook_handle pvUser);
	...
	int ISQLite3Provider.sqlite3_config_log(delegate_log func, object v)
	{
		...
		return NativeMethods.sqlite3_config_log(16, func2, (hook_handle)(disp_log_hook_handle = new hook_handle(target)));
	}
