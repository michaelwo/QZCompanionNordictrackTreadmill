...
public class QzProtocol {
    ...
    public static Command decodeBike(QzPacket pkt) {
        ...
        if (pkt.fieldCount() == 2) {
            ...
            Float v = parseField(pkt.rawField(0));
    ...
    public static Command decodeTreadmill(QzPacket pkt) {
        Command cmd = new Command();
        if (pkt.fieldCount() == 2) {
            Float s = parseField(pkt.rawField(0));
            Float i = parseField(pkt.rawField(1));
