...
public class X32iDevice extends TreadmillDevice {
    private static final int THUMB_Y_RIGHT = 927;
    private static final int THUMB_Y_LEFT  = 881;

    public X32iDevice() {
        // Screen: 1920px wide — trackX confirmed against iFit APK layout XML (tools/validate_swipe_targets.py).
        // initialThumbYRight=927 starts below targetY(0)≈835; conservative position ensures the first speed swipe always travels upward.
        super(
