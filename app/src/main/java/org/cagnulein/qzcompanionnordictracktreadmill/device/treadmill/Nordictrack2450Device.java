...
public class Nordictrack2450Device extends TreadmillDevice {
    private static final int ORIGIN_INCLINE_THUMBY = 715;
    private static final int ORIGIN_SPEED_THUMBY   = 807;

    public Nordictrack2450Device() {
        // Screen: 1920px wide — trackX confirmed against iFit APK layout XML (tools/validate_swipe_targets.py).
        super(
            new Slider(ScreenProfile.W1920.leftTrackX, ORIGIN_INCLINE_THUMBY, Nordictrack2450Device::offsetInclineThumbY) {
                protected int currentThumbY(MetricSnapshot current) { return targetThumbY(current.incline()); }
            },
            new Slider(ScreenProfile.W1920.rightTrackX, ORIGIN_SPEED_THUMBY, Nordictrack2450Device::offsetSpeedThumbY) {
