...
public class Nordictrack2950MaxSpeed22Device extends TreadmillDevice {
    ...
    private static final int ORIGIN_SPEED_THUMBY   = 682;

    public Nordictrack2950MaxSpeed22Device() {
        // Screen: 1920px wide — trackX confirmed against iFit APK layout XML (tools/validate_swipe_targets.py).
        super(
            new Slider(ScreenProfile.W1920.leftTrackX, ORIGIN_INCLINE_THUMBY, Nordictrack2950MaxSpeed22Device::offsetInclineThumbY) {
                protected int currentThumbY(MetricSnapshot current) { return targetThumbY(current.incline()); }
            },
            new Slider(ScreenProfile.W1920.rightTrackX, ORIGIN_SPEED_THUMBY, Nordictrack2950MaxSpeed22Device::offsetSpeedThumbY) {
    ...
    private static int offsetSpeedThumbY(double v)   { return ORIGIN_SPEED_THUMBY - (int) ((v - 1.0) * 26.5); }
}
