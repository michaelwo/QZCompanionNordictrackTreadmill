 ...
 */
class TailGrepMetricReader implements MetricReader {

    private final boolean ifitV2;

    TailGrepMetricReader()              { this(false); }
    TailGrepMetricReader(boolean ifitV2) { this.ifitV2 = ifitV2; }

    static int truncateCounter = 0;
